...
class AdminGridViewWidget extends CGridView
{
    // Table types.
    ...
    protected function initColumns()
    {
        foreach ($this->columns as $i => $column) {
            if (is_array($column) && !isset($column['class'])) {
                $this->columns[$i]['class'] = 'ext.mAdmin.widgets.AdminDataColumnWidget';
            }
        }
     ...
     *
     * @return \AdminDataColumnWidget|\CDataColumn the column instance
    ...
    protected function createDataColumn($text)
    {
        ...
        $column = new AdminDataColumnWidget($this);
    ...
    protected function writeResponsiveCss()
    {
        ...
        foreach ($this->columns as $column) {
            /** @var AdminDataColumnWidget $column */
            ob_start();
