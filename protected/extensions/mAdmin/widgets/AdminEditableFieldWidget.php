...
Yii::import('ext.mAdmin.widgets.AdminEditableWidget');

class AdminEditableFieldWidget extends AdminEditableWidget
{
    /**
    ...
    public function init()
    {
        ...
        if (!$this->model->isNewRecord) {
            $this->pk = is_array($this->model->primaryKey)
                ? CJSON::encode($this->model->primaryKey)
                : $this->model->primaryKey;
        }

        $originalText = strlen($this->text)
            ? $this->text
