 ...
 * AdminActiveFormWidget brings together all of these things to quickly build custom forms even with non-standard fields.
 *
 ...
 * <pre>
 * <?php $form = $this->beginWidget('ext.mAdmin.widgets.AdminActiveFormWidget', array(
 *     'type' => 'horizontal',
 ...
 * with {@link AdminActiveFormWidget::widgetRow} and {@link AdminActiveFormWidget::customFieldRow}.
 ...
 * @see CActiveForm
 */
class AdminActiveFormWidget extends CActiveForm
{
    // Allowed form types.
    ...
    public function init()
    {
        ...
        if (!isset($this->errorMessageCssClass)) {
            $this->errorMessageCssClass = ($this->inlineErrors)
                ? 'help-inline error'
                : 'help-block error';
        }
        ...
        CHtml::$afterRequiredLabel = ' <small><small><i class="fa fa-asterisk text-danger"></i></small></small>';
    ...
    public function checkBoxRow($model, $attribute, $htmlOptions = array(), $rowOptions = array())
    {
        ...
        self::addCssClass($htmlOptions, 'ace');
     ...
     *
     * This method is a wrapper for {@link AdminToggleButtonWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminToggleButtonWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminToggleButtonWidget
     * @see customFieldRow
     */
    public function toggleButtonRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return 'ToggleButton is not supported yet';
        //return $this->widgetRowInternal('ext.widgets.AdminToggleButtonWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a date picker row for a model attribute.
     *
     * This method is a wrapper for {@link AdminDatePickerWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminDatePickerWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     *
     * This method is a wrapper for {@link AdminDateRangePickerWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminDateRangePickerWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminDateRangePickerWidget
     * @see customFieldRow
     */
    public function dateRangeRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return 'DateRangePicker is not supported yet';
        //return $this->widgetRowInternal('ext.mAdmin.widgets.AdminDateRangePickerWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a time picker row for a model attribute.
     *
     * This method is a wrapper for {@link AdminTimePickerWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminTimePickerWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     *
     * This method is a wrapper for {@link AdminDateTimePickerWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminDateTimePickerWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminDateTimePickerWidget
     * @see customFieldRow
     */
    public function dateTimePickerRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return 'DateTimePicker is not supported yet';
        //return $this->widgetRowInternal('ext.mAdmin.widgets.AdminDateTimePickerWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a select2 row for a model attribute.
     *
     * This method is a wrapper for {@link AdminSelect2Widget} widget and {@link customFieldRow}.
     * Please check {@link AdminSelect2Widget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminSelect2Widget
     * @see customFieldRow
     */
    public function select2Row($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return $this->widgetRowInternal('ext.mAdmin.widgets.AdminSelect2Widget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a redactor editor row for a model attribute.
     *
     * This method is a wrapper for {@link AdminRedactorJsWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminRedactorJsWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminRedactorJsWidget
     * @see customFieldRow
     */
    public function redactorRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return 'RedactorJs is not supported yet';
        //return $this->widgetRowInternal('ext.mAdmin.widgets.AdminRedactorJsWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a html5 editor row for a model attribute.
     *
     * This method is a wrapper for {@link AdminHtml5EditorWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminHtml5EditorWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminHtml5EditorWidget
     * @see customFieldRow
     */
    public function html5EditorRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return 'Html5Editor is not supported yet';
        //return $this->widgetRowInternal('ext.mAdmin.widgets.AdminHtml5EditorWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a markdown editor row for a model attribute.
     *
     * This method is a wrapper for {@link AdminMarkdownEditorJsWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminMarkdownEditorJsWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     *
     * This method is a wrapper for {@link AdminCKEditorWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminCKEditorWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminCKEditorWidget
     * @see customFieldRow
     */
    public function ckEditorRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return $this->widgetRowInternal('ext.mAdmin.widgets.AdminCKEditorWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }

    /**
     * Generates a type-ahead row for a model attribute.
     *
     * This method is a wrapper for {@link AdminTypeaheadWidget} widget and {@link customFieldRow}.
     * Please check {@link AdminTypeaheadWidget} documentation for detailed information about $widgetOptions.
     * About $rowOptions argument parameters see {@link AdminActiveFormWidget} documentation.
     *
     * @param CModel $model The data model.
     * @param string $attribute The attribute.
     ...
     * @see AdminTypeaheadWidget
     * @see customFieldRow
     */
    public function typeAheadRow($model, $attribute, $widgetOptions = array(), $rowOptions = array())
    {
        return 'TypeAhead is not supported yet';
        //return $this->widgetRowInternal('ext.widgets.widgets.AdminTypeaheadWidget', $model, $attribute, $widgetOptions, $rowOptions);
    }
    ...
    protected function horizontalFieldRow(&$fieldData, &$model, &$attribute, &$rowOptions)
    {
        ...
        self::addCssClass($rowOptions['labelOptions'], 'control-label col-sm-3');
        if (isset($rowOptions['label'])) {
    ...
    protected function initHtmlOptions(&$options)
    {
        $options['class'] = (isset($options['class']) ? $options['class'].' ' : '') . 'col-xs-10 col-sm-8'; 
    }
